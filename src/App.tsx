  ...
  return (
    <>
      ...
      <WindowContext.Provider value={{ stateWindow, setStateWindow }}>
        <div className='h-full md:h-[80vh] w-200 flex md:grid grid-cols-[auto_1fr] rounded m-auto p-3 backdrop-blur-xs bg-linear-to-tr from-slate-300 dark:from-neutral-900 to-slate-100/10 dark:to-black/10 border border-neutral-500 relative'>
          <Aside />
          <Main />
        </div >
