...
export function Aside_movil() {
    return (
        <>
            <Sheet aria-describedby={'Side movil'}>
                <SheetTrigger>
                ...
                <SheetContent className='bg-linear-to-tr from-neutral-300 dark:from-neutral-900 to-slate-300 dark:to-black/10 border border-neutral-700 shadow-2xl shadow-neutral-50/5 px-15 pb-5' aria-describedby={'Side movil'}>
                    <SheetTitle className="text-center font-bold my-5" aria-describedby={'Side movil'}>Adán Luis Quincoces Escalona</SheetTitle>
                    <Avatar_own />
